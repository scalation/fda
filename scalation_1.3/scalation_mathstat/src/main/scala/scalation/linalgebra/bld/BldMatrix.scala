      ...
      extends $MATRI with Error with Serializable
{
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Convert 'this' `$MATRIX` into a `MatrixI`.
     */
    def toInt: MatrixI =
    {
    ...
    {
        if (from >= end) return new $MATRIX (0, 0)
...
//  } // t
    ...
    def solve (l: $MATRI, u: $MATRI, b: $VECTO): $VECTOR =
    {
        ...
        u.bsolve (y).asInstanceOf [$VECTOR]
    } // solve
     ...
     *  @param b   the constant vector
     */
    def solve (lu: ($MATRI, $MATRI), b: $VECTO): $VECTOR = solve (lu._1, lu._2, b)
     ...
     *  @param b  the constant vector
     */
    def solve (u: $MATRI, b: $VECTO): $VECTOR = solve (this, u, b)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Solve for 'x' in the equation 'a*x = b' where 'a' is 'this' matrix.
     *  @param b  the constant vector.
     */
    def solve (b: $VECTO): $VECTOR = solve (lud, b)
